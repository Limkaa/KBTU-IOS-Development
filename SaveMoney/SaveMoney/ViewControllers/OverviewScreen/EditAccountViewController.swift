...
class EditAccountViewController: UIViewController {
    ...
    func setupViewElements() {
        accountTitleField.text = currentAccount.title
        balanceAmount.text = currentAccount.amount.formattedWithSeparator
        if currentAccount.type == "debit-card" {
    ...
    @IBAction func addPressed(_ sender: UIButton) {
        ...
        if accountTitleField.text?.stringByRemovingWhitespaces != "" {
            ...
            currentAccount.title = accountTitleField.text
            currentAccount.type = choosenAccountType
            currentAccount.amount = Int32(balanceAmount.text!.stringByRemovingWhitespaces)!
